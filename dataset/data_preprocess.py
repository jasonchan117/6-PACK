...
image_dir = "/Volumes/GoogleDrive/My Drive/Dataset/NOCS/data/train"
scale_dir = "/Volumes/GoogleDrive/My Drive/Dataset/NOCS/model_scales"
pose_dir = "/Volumes/GoogleDrive/My Drive/Dataset/NOCS/data_pose/train"
...
for folder in folder_list:
    ...
    #
    #     continue
    bb_dir = glob.glob(os.path.join(pose_dir, folder, '*_bbox.txt'))
    num = num + 1
    if (len(bb_dir) == 0):
        b_num += 1
        print('->', b_num)
                            ...
                            if len(input_line) == 1:
                                if int(input_line[0]) == inst_id:
                                    for i in range(4):
                                        ...
                                        input_line = input_line.split(' ')
                                        pose.append([float(input_line[0]), float(input_line[1]), float(input_line[2]),
                                                     float(input_line[3])])
                                    break
                    pose = np.array(pose)
